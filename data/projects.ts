...
+----------------------------------------------------------------------+`,
  ...
  },
  {
    ...
    complexity: 2,
    pinned: false,
    summary: '2D roguelike built in Godot. An early prototype focused on items, combat, and visual effects.',
    body: [
...
+------------------------------------+  |                              |
  ...
  },
  {
    ...
    summary:
      'My personal development log: a static Next.js site with project writeups, architecture diagrams, and a Markdown blog.',
    body: [
      'My personal development log is a fully static Next.js App Router project styled with Tailwind. Identity and projects live in typed data files, blog posts are plain markdown, and everything else renders from those, including the RSS feed and sitemap.',
  ...
  },
  {
    ...
    summary:
      'Build a NixOS config in the browser from real nixpkgs data, then push it to your repo as a pull request.',
    body: [
...
+------------------------------------------------------------------+
 ...
 +------------------------+   +----------------------------+
  ...
  },
  {
    ...
    summary:
      'Randomize anything. Any list, any source, twenty-plus methods from roulette wheel to plinko. A rebuild of my original family movie picker, preserved in og/.',
    body: [
      ...
      'The design keeps the monochrome character of the original: ink on warm paper, halftone dots, hard offset shadows, the original BPdots brand font. This is a rebuild of the first website I ever made, to help my brothers and me pick a movie. The original site is preserved in the og/ directory.',
    ],
    changelog: [
